...
export async function POST(req: Request) {
  try {
    ...
    const prompt = `
    PRIMARY MISSION: Beat AI detectors by maximizing BURSTINESS and PERPLEXITY while keeping IELTS Band 7 clause level (4 types) and Band 6 vocabulary. Scientific terms stay exact.
